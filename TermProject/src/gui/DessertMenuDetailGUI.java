...
import cafe.Drink;
import cafe.Review;
import gui.DrinkMenuDetailGUI.AddToCart;

public class DessertMenuDetailGUI extends JPanel {
   int Imagewidth = 180;
   int ImageHeight = 180;
   int page;
   int index;
   ...
   public DessertMenuDetailGUI(Cafe cafe, int index) {
      this.index = index;
      this.cafe = cafe;
      paintGUI();
   }
   ...
   public void paintGUI() {
      ...
      MenuButton.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
            ...
            revalidate();
            repaint();
            add(new AllDessertMenusGUI());
         }
      });
      
      menu = (Dessert) cafe.menudessertMgr.mList.get(index);
      // 이미지
      ...
      JTextArea materials = new JTextArea(tmp,4,15);
      ...
      PrevButton.setBounds(220, 510, 80, 30);// 10, 550, 465, 200
      ...
      if (indexs[page] != null) {
         ...
         if (index_review < StartGUI.cafe.reviewMgr.mList.size()) {
