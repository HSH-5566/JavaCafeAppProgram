...
public class Cafe extends Manager {
	...
	public void basicSearchDrink(String name) {
	...
	public void basicSearchDessert(String name) {
	...
	public void run() throws IOException {
		readFiles();
		sortDrinkSale();
		// showFunctionMenu(); // GUI 실행할 때는 주석처리 해야함
	}
	...
	public void showFunctionMenu() throws IOException {
		Scanner scan = new Scanner(System.in);
		boolean end = false;
		while (true) {
	...
	void addMenuData() throws IOException { // 1번
		...
		case 0:
			...
			menudrinkMgr.rewriteFile(new FileWriter("drinkTmp.txt"));
		...
		case 1:
			...
			menudessertMgr.rewriteFile(new FileWriter("dessertTmp.txt"));
	...
	void modifyReviewData() throws IOException { // 후기데이터 수정
		...
		reviewMgr.rewriteFile(new FileWriter("reviewTmp.txt"));
	...
	public void addReviewData(Review review) throws IOException { // 후기 데이터 추가
		...
		reviewMgr.rewriteFile(new FileWriter("practice.txt"));
	...
	public void recommendation(String id) {
	  ...
	  public void sortReviewStar() {
	   ...
	   public void sortDessertNameAsc() {
	      Collections.sort(menudessertMgr.mList, new Comparator<Manageable>() {
	         @Override
	         public int compare(Manageable o1, Manageable o2) {
	   ...
	   public void sortDessertNameDes() {
	      Collections.sort(menudessertMgr.mList, new Comparator<Manageable>() {
	         @Override
	         public int compare(Manageable o1, Manageable o2) {
	            Dessert dessert1 = (Dessert) o1;
